...
const { toLong, toNum, syncServerTime, log, logWarn, sleep, randomDelay, randomInRange } = require('./utils');
...
function connect(code, onLoginSuccess) {
    ...
    ws.on('close', (code, _reason) => {
        ...
        if (savedLoginCallback) {
            ...
            const jitteredDelay = delay + randomInRange(0, Math.floor(delay * 0.3));
            networkScheduler.setTimeoutTask('auto_reconnect', jitteredDelay, () => {
